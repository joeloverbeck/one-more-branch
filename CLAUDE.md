...
│   ├── writer-generation.ts      # Page narrative generation (no choices)
...
This project is indexed by GitNexus as **one-more-branch** (5582 symbols, 14484 relationships, 300 execution flows).
