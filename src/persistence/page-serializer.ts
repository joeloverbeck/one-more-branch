...
export function serializePage(page: Page): PageFileData {
  ...
  return {
    ...
    choices: page.choices.map((choice) => ({
      ...
      ...(choice.choiceSubtype !== undefined ? { choiceSubtype: choice.choiceSubtype } : {}),
      ...(choice.choiceShape !== undefined ? { choiceShape: choice.choiceShape } : {}),
    })),
...
export function deserializePage(data: PageFileData): Page {
  ...
  return {
    ...
    choices: data.choices.map((choice) => ({
      ...
      ...(choice.choiceShape != null ? { choiceShape: choice.choiceShape as ChoiceShape } : {}),
    })),
    activeStateChanges,
