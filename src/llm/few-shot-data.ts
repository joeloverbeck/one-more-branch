...
export const OPENING_EXAMPLE_RESPONSE = JSON.stringify(
  {
    ...
    protagonistAffect: {
      ...
      primaryCause: 'Professor Grimwald called on you while you were studying the forbidden journal',
      secondaryEmotions: [
        { emotion: 'curiosity', cause: 'The journal hints at a hidden library beneath the academy' },
      ],
      dominantMotivation: 'Protect the journal and keep pursuing forbidden knowledge',
    },
    sceneSummary:
...
export const CONTINUATION_EXAMPLE_RESPONSE = JSON.stringify(
  {
    ...
    protagonistAffect: {
      ...
      primaryIntensity: 'strong',
      primaryCause: 'A senior faculty member is approaching while you stand beside the hidden mechanism',
      secondaryEmotions: [
        { emotion: 'focus', cause: 'The third rune may open the passage described in the journal' },
      ],
      dominantMotivation: 'Avoid discovery and reach the hidden library entrance',
    },
    sceneSummary:
...
export const ENDING_EXAMPLE_RESPONSE = JSON.stringify(
  {
    ...
    protagonistAffect: {
      ...
      primaryIntensity: 'strong',
      primaryCause: 'The Codex has been bound and the immediate danger is over',
      secondaryEmotions: [
        { emotion: 'pride', cause: 'You completed the ritual and earned Grimwald’s respect' },
      ],
      dominantMotivation: 'Begin the next chapter of study responsibly',
    },
    sceneSummary:
