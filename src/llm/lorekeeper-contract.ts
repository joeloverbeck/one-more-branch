...
export const LOREKEEPER_CURATION_PRINCIPLES: ReadonlyArray<string> = [
  ...
  'EPISTEMIC FIDELITY: When world facts are tagged with epistemic status (LAW, BELIEF, RUMOR, MYSTERY, etc.), preserve that status in the Story Bible. Do not present beliefs as settled truth, rumors as confirmed facts, or resolve mysteries. Characters may be wrong about the world - this ambiguity is narratively valuable.',
];
