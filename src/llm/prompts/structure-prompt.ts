...
function buildSetpieceBankSection(_verification?: ConceptVerification): string {
  // Setpiece bank is now generated by the macro architecture stage, not sourced from verification.
  // This legacy structure prompt is kept for backward compatibility but no longer includes setpieces.
  return '';
}
