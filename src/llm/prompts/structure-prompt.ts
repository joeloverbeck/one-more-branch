...
17. Flag exactly one beat across the full structure as isMidpoint: true. This beat should sit near the structural center and deliver a major reveal or reversal. For that beat, set midpointType to:
...
19. For each beat with role "escalation" or "turning_point", assign 2-3 approachVectors suggesting HOW the protagonist could tackle this beat. Choose from:
