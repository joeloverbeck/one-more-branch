  ...
  it('maintains branching integrity with distinct accumulated states', async () => {
    ...
    for (const branch of branchPages) {
      const page = createPage({
        ...
        choices: [],
        stateChanges: [branch.stateChange],
        isEnding: true,
        parentPageId: parsePageId(1),
