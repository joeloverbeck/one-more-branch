...
const openingResult = {
  ...
  stateChangesAdded: ['Clock anomaly observed in capital square'],
  stateChangesRemoved: [],
...
function buildContinuationResult(selectedChoice: string, pageNumber: number): typeof openingResult {
  if (selectedChoice.includes('Pursue')) {
    return {
      ...
      stateChangesAdded: [`Courier evidence secured on page ${pageNumber}`],
      stateChangesRemoved: [],
  ...
  if (selectedChoice.includes('Press deeper')) {
    return {
      ...
      stateChangesAdded: [`Signal chamber logs copied on page ${pageNumber}`],
      stateChangesRemoved: [],
  ...
  return {
    ...
    stateChangesAdded: [`Guard pattern mapped on page ${pageNumber}`],
    stateChangesRemoved: [],
