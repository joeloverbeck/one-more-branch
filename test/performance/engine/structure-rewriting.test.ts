        ...
        beats: [
          {
            ...
            objective: 'Ground character',
            causalLink: 'Establishes baseline stakes and motivations.',
          },
          {
            id: '1.2',
            description: 'Inciting incident',
            objective: 'Force decision',
            causalLink: 'Disrupts the baseline and demands an immediate response.',
          },
          {
            id: '1.3',
            description: 'Debate',
            objective: 'Show hesitation',
            causalLink: 'Pressure from the incident surfaces internal resistance.',
          },
          {
            id: '1.4',
            description: 'Cross threshold',
            objective: 'Commit to quest',
            causalLink: 'Resolving hesitation commits the protagonist to a new context.',
          },
        ],
      },
      {
        ...
        beats: [
          {
            ...
            objective: 'Build coalition',
            causalLink: 'Crossing the threshold introduces new challenges and potential allies.',
          },
          {
            id: '2.2',
            description: 'Midpoint shift',
            objective: 'Reveal new truth',
            causalLink: 'Field tests uncover information that reframes the mission.',
          },
          {
            id: '2.3',
            description: 'Crisis',
            objective: 'Push to brink',
            causalLink: 'The midpoint truth intensifies external and internal pressure.',
          },
          {
            id: '2.4',
            description: 'Decision',
            objective: 'Choose final approach',
            causalLink: 'Crisis forces commitment to a definitive strategy.',
          },
        ],
      },
      {
        ...
        beats: [
          {
            ...
            objective: 'Face antagonist',
            causalLink: 'The chosen strategy leads directly into decisive confrontation.',
          },
          {
            id: '3.2',
            description: 'Sacrifice',
            objective: 'Pay cost',
            causalLink: 'Confrontation reveals the cost required to prevail.',
          },
          {
            id: '3.3',
            description: 'Victory',
            objective: 'Resolve central conflict',
            causalLink: 'Accepting sacrifice enables successful resolution.',
          },
          {
            id: '3.4',
            description: 'Aftermath',
            objective: 'Show new equilibrium',
            causalLink: 'Victory establishes transformed conditions for the world.',
          },
        ],
      },
    ],
