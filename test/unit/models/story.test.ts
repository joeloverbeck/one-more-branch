...
function createTestStructure(): StoryStructure {
  return {
        ...
        milestones: [
          {
            ...
            causalLink: 'Because the village messenger arrives with proof.',
            role: 'setup',
            escalationType: null,
        ...
        milestones: [
          {
            ...
            causalLink: 'Because the enemy withdrew outer patrols after the decoy.',
            role: 'turning_point',
        ...
        milestones: [
          {
            ...
            causalLink: 'Because the fortress breach exposed the ritual chamber.',
            role: 'resolution',
            escalationType: null,
            secondaryEscalationType: null,
            crisisType: null,
    ...
    premise: 'A hunted hero must stop a world-ending ritual before dawn.',
    openingImage: 'A lone lantern glowing in a ruined chapel.',
    closingImage: 'The same chapel at sunrise, crowded with survivors.',
