...
describe('Story', () => {
  describe('createStory', () => {
    it('creates story with only required characterConcept', () => {
    ...
    it('trims whitespace from characterConcept, worldbuilding, and tone', () => {
      const story = createStory({
    ...
    it("throws 'Character concept is required' for empty string", () => {
      expect(() => createStory({ characterConcept: '' })).toThrow('Character concept is required');
    });
