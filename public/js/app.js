...
const STAGE_PHRASE_POOLS = {
  ...
  BLUEPRINTING_SCENE: [
    'Drafting the scene\'s internal skeleton...',
    'Measuring emotional distances between paragraphs...',
    'Laying out motivation-reaction dominoes...',
    'Assigning sensory anchors to each beat...',
    'Calculating the paragraph weight budget...',
    'Mapping mandates to their structural homes...',
    'Sequencing the emotional arc trajectory...',
    'Deciding who speaks and when they shut up...',
    'Placing conflict where it hurts most...',
    'Architecting disaster at the optimal moment...',
    'Designing the internal topography of tension...',
    'Allocating screen time to each story function...',
    'Tuning the scene\'s emotional frequency spectrum...',
    'Plotting the sensory breadcrumb trail...',
    'Balancing action and reaction like a seesaw...',
    'Scheduling the scene\'s emotional weather system...',
    'Wiring motivation circuits to reaction outputs...',
    'Blueprinting the paragraph-level drama highway...',
    'Installing load-bearing emotional supports...',
    'Drawing the scene\'s nervous system in invisible ink...',
  ],
  ...
  EVALUATING_CONCEPTS: [
    ...
    'Checking whether the premise still crackles under scrutiny...',
  ...
  GENERATING_WORLD_SEED: [
    'Planting the deep roots of a world that breathes...',
    'Discovering what is always true here and what it costs...',
    'Mapping the fault lines where cultures grind against each other...',
    'Identifying the pressures that make this world demand stories...',
    'Building the invariants that shape every life lived here...',
    'Asking who holds power and where the cracks show...',
    'Designing the everyday rituals that reveal hidden hierarchies...',
    'Seeding the mysteries that everyone knows but nobody understands...',
    'Constructing the sensory palette of a place you can almost smell...',
    'Laying down the story vectors that branch into possibility...',
    'Crafting the naming conventions that make a culture feel real...',
    'Determining what daily life feels like under these skies...',
    'Finding the anchor locations where scenes will inevitably happen...',
    'Establishing the taboos that make certain choices unthinkable...',
    'Tracing the power structures that touch bodies and habits...',
  ],
  ELABORATING_WORLD: [
    'Expanding the seed into a world writers can inhabit...',
    'Atomizing world logic into facts that prompts can use...',
    'Turning invariants into lived consequences and sensory details...',
    'Building the canonical fact sheet of a fictional reality...',
    'Distinguishing public truths from hidden pressures...',
    'Assigning narrative weight to every world detail that matters...',
    'Connecting facts into a web of tension and implication...',
    'Writing the world logline that captures everything in one breath...',
    'Identifying the open questions that keep the world alive...',
    'Tagging each fact with the story functions it can serve...',
    'Generating the scene affordances that make choices world-rooted...',
    'Cataloguing beliefs, rumors, and disputed truths...',
    'Elaborating the world into a machine-readable canon...',
...
const STAGE_DISPLAY_NAMES = {
  GENERATING_SPINE_FOUNDATION: 'LAYING FOUNDATIONS',
  GENERATING_SPINE_ARC_ENGINE: 'FORGING THE ARC',
  SYNTHESIZING_SPINE: 'SYNTHESIZING',
  IDEATING_SCENE: 'ENVISIONING',
  PLANNING_PAGE: 'PLANNING',
  ACCOUNTING_STATE: 'ACCOUNTING',
  CURATING_CONTEXT: 'LOREKEEPING',
  BLUEPRINTING_SCENE: 'BLUEPRINTING',
