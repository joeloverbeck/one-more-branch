...
- Spark outputs already preserve the exact fields later needed for saved-asset `origin.sourceArtifacts`: `sparkId`, `contentKind`, `spark`, `imageSeed`, and `collisionTags`
